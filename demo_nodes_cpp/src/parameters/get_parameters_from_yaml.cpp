...
class GetParametersFromYaml : public rclcpp::Node
{
public:
  DEMO_NODES_CPP_PUBLIC
  explicit GetParametersFromYaml(const rclcpp::NodeOptions & options)
  : Node("get_parameters_from_yaml", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(demo_nodes_cpp::GetParametersFromYaml)
